...
ℹ️ **لمعرفة طريقة تشغيل هذا البوت اضغط على » طريقة التشغيل!**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "ℹ️ كروب السورس ℹ️", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "ℹ️ تحديثات البوت ℹ️", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "📣 مطور السورس 📣", url="https://t.me/Xl444/22"
                    )
                ],
            ]
        ),
...
ℹ️ ** اي مشكلة تواجها لاتتردد في التحدث مع المطور: @VFF35**
